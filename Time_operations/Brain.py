...
def parse_input(input_text):
    ...
    if times:
        ...
        formatted_output = f"{formatted_time} = Deepu this is Your {updated_input_text} time"
...
def input_manage(input_text):
        ...
        if output != "No valid time found in input":
            save_to_file(output, time, r'A:\Jarvis\schedule.txt')
            print("sheduled data saved")
        else:
            print(output)
...
def input_manage_alarm(input_text):
        ...
        if time != "No valid time found in input":
            save_to_alarmfile(time, r'A:\Jarvis\Alarm_data.txt')
            print("sheduled data saved")
        else:
            print("pass")
